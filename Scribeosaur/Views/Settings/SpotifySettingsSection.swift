...
struct SpotifySettingsSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Spacing.md) {
            ...
            settingsCard {
                VStack(alignment: .leading, spacing: Spacing.sm) {
                    Text("Scribeosaur uses the Spotify API to browse your saved podcasts and discover episodes. Audio is downloaded from public RSS feeds (not from Spotify directly).")
                        .font(Typography.caption)
                        .foregroundStyle(ColorTokens.textMuted)
            ...
            settingsCard {
                VStack(alignment: .leading, spacing: Spacing.sm) {
                    if appState.spotifyAuthService.isAuthenticated {
                        ...
                        Text("When enabled, Scribeosaur periodically checks your Spotify saved episodes for newly finished listens and automatically enqueues them for transcription.")
                            .font(Typography.caption)
                            .foregroundStyle(ColorTokens.textMuted)
                    } else {
