...
struct Transcript: Codable, Identifiable, Equatable {
    ...
    enum SourceType: String, Codable, DatabaseValueConvertible, Sendable {
        case file
        case recording
        case url
    }

    enum RemoteSource: String, Codable, DatabaseValueConvertible, Sendable {
        case youtube
        case spotify
    }

    enum CollectionType: String, Codable, DatabaseValueConvertible, Sendable {
        case playlist
        case channel
        case show
    }

    enum TranscriptStatus: String, Codable, DatabaseValueConvertible, Sendable {
        case processing
        case completed
        case failed
    }
